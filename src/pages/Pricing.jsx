    ...
    >
      ...
      <div className="mt-6">
        <a
          href={
            plan.id === "freemium"
              ? "/resume-builder/app/choose-templates"
              : "/pricing"
          }
...
const Pricing = () => {
  ...
  return (
    <>
      ...
      <section className="max-w-[1600px] mx-auto p-6">
        <div className="text-center mb-12">
          <span className="inline-block text-[#EA723C] py-1 px-4 font-bold rounded-full text-xs">
            PRICING
          </span>
          <h1 className="text-5xl text-[#24272E] font-bold my-4">
            Invest in your career with confidence
          </h1>
          <p className="text-[#52575E] max-w-2xl mx-auto">
            Flexible plans for jobseekers at every stage — start free or upgrade
            for AI features and priority support.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8">
          <div>
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <div>
                ...
                <p className="mt-1">
                  You can choose monthly or yearly billing. Yearly saves roughly
                  two months compared to monthly.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1">
                  Yes. Cancel from your account dashboard and you'll retain
                  access for the period you've paid for.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1">
                  We offer a 30-day money-back guarantee for Premium. Contact
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              ...
              using TLS. Payment processing is handled by PCI-compliant
              providers. For enterprise customers we offer additional data
              controls and contractual protections.
            </p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto bg-gradient-to-r from-[#FBF7F5] to-[#FFF8F4] rounded-2xl p-8 text-center">
          <h3 className="text-2xl font-bold mb-3">
            Need a plan for teams or education?
          </h3>
          <p className="text-gray-700 mb-6">
            We offer discounted plans for teams, universities, and career
            centers. Get a custom quote and dedicated onboarding.
          </p>
          <div className="flex items-center justify-center gap-4">
            <a
              href="/contact"
              className="bg-[#EA723C] text-white px-5 py-3 rounded-lg font-semibold"
            >
              Contact sales
            </a>
            <a
