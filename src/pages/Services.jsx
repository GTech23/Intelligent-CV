  ...
  <div className="bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col justify-between hover:shadow-md transition">
    <div>
      ...
      <h3 className="text-xl font-semibold mb-2 flex items-center justify-between">
        ...
        {service.comingSoon && (
          <span className="ml-3 inline-block text-xs font-semibold text-[#EA723C] bg-[#FFF3EE] px-2 py-1 rounded-full">
            Coming soon
          </span>
        )}
      </h3>
    ...
    <div className="mt-6">
      {service.comingSoon ? (
        <span className="inline-block text-sm font-medium text-gray-500 bg-gray-100 px-3 py-2 rounded-lg">
          Coming soon
        </span>
      ) : (
        <Link
        ...
        <div className="max-w-6xl mx-auto grid gap-8 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              From AI-assisted resume creation to personalized coaching, our
              services are designed to improve your chances at every stage of
              the job search.
            </p>
            ...
            <p className="mt-6 text-sm text-zinc-500">
              Need help choosing? Chat with our career advisors for a free
              consultation.
            </p>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-gradient-to-br from-[#fff] to-[#FFF8F4] rounded-2xl p-6 shadow-md">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Pick a service and we’ll guide you through the next steps.
              </p>
                  ...
                  s.comingSoon ? (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 flex items-center justify-center bg-[#FFF3EE] rounded-md">
                          {s.icon}
                        </div>
                        <div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-10 max-w-3xl mx-auto">
            Choose the service that fits your timeline and budget — we make
            professional results accessible.
          </p>
